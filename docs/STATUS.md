...
The later development-card hover and stolen-card animation checkpoint passes `pnpm check` with 317 tests across 74 files and `pnpm build` on the settled source.
